...
// Masternode tiers
static std::map<int, int> masternodeTiers = map_list_of (1, 6000) (2, 12000) (3, 24000) (4, 36000) (5, 48000) (6, 60000); 

// Masternode tier rewards
static std::map<int, int> masternodeTierRewards = map_list_of (1, 10) (2, 24) (3, 58) (4, 98) (5, 139) (6, 187); 

//
// The Masternode Class. For managing the darksend process. It contains the input of exact amount of MAZE, signature to prove
