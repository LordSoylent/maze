...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\MAZE
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\MAZE
    // Mac: ~/Library/Application Support/MAZE
    // Unix: ~/.MAZE
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MAZE";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "MAZE.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "MAZEd.pid"));
