...
private slots:
    ...
    QString BuyMAZE(QString OrderType, double Quantity, double Rate);
    QString SellMAZE(QString OrderType, double Quantity, double Rate);
